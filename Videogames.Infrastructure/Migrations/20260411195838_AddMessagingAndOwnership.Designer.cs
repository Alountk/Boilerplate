...
namespace Videogames.Infrastructure.Migrations
{
    ...
    [Migration("20260411195838_AddMessagingAndOwnership")]
    partial class AddMessagingAndOwnership
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Videogames.Domain.Entities.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Videogames.Domain.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Videogames.Domain.Entities.Conversation", b =>
                {
                    b.HasOne("Videogames.Domain.Entities.User", "Buyer")
                        .WithMany()
                        .HasForeignKey("BuyerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Videogames.Domain.Entities.User", "Seller")
                        .WithMany()
                        .HasForeignKey("SellerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Videogames.Domain.Entities.Videogame", "Videogame")
                        .WithMany()
            ...
            modelBuilder.Entity("Videogames.Domain.Entities.Message", b =>
                {
                    b.HasOne("Videogames.Domain.Entities.Conversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Videogames.Domain.Entities.User", "Sender")
                        .WithMany()
