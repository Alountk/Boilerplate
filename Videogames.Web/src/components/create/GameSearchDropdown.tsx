...
export function GameSearchDropdown({
  ...
  if (loading) {
    return (
      <div className="absolute z-50 w-full mt-2 bg-surface-container rounded-lg shadow-2xl border border-outline-variant/30 top-full">
        <div className="flex items-center gap-3 p-4 text-on-surface-variant text-sm">
      ...
      {results.map((game) => (
        ...
        >
          {game.background_image ? (
            ...
            <div className="w-12 h-12 bg-surface-container-high flex items-center justify-center rounded" aria-hidden="true">
